...
util.inherits(Shard, events.EventEmitter);
...
Shard.prototype.results = function(callback) {
...
Shard.prototype.performRequest = function(command, callback) {
...
Shard.prototype._connect = function() {
...
Shard.prototype._disconnect = function() {
	this.state = NOT_CONNECTED;
...
Shard.prototype._processNextRequest = function() {
...
Shard.prototype._readJsonObject = function(callback) {
	var self = this;

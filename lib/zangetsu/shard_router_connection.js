...
function ShardRouterConnection(configuration, router) {
...
ShardRouterConnection.prototype.listLocks = function(callback) {
	var command = {
		command   : 'listLocks'
	}
...
ShardRouterConnection.prototype.lock = function(group, dayTimestamp, callback) {
	var command = {
		command   : 'giveLock',
		group     : group,
		dayTimestamp : dayTimestamp,
		identifier: this.router.identifier
	}
	this.performRequest(command, callback);
}

ShardRouterConnection.prototype.releaseLock = function(group, dayTimestamp, result, callback) {
	var command = {
		command : 'releaseLock',
		group : group,
		dayTimestamp : dayTimestamp,

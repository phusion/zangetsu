...
ShardConnection.prototype.add = function(groupName, timestamp, opid, size, buffers, callback, options) {
	var command = {
		command   : 'add',
		group     : groupName,
		timestamp : timestamp,
...
// Remove a group from the shard or remove all of its data before timestamp

 ...
 * @param {Number} level 
 * @param {Object} stream 
 * @param {Object} err_stream 
 * @api public
 */

var Log = exports = module.exports = function Log(level, stream, err_stream){
  if ('string' == typeof level) level = exports[level.toUpperCase()];
  this.level = level || exports.DEBUG;
  this.stream = stream || process.stdout;
  this.err_stream = err_stream || process.stderr;
...
Log.prototype = {
  ...
  log: function(levelStr, args) {
    var level = exports[levelStr];
    if (level <= this.level) {
      var i = 1;
      var msg = util.format.apply(util.format, args);
      var stream = (level <= exports.WARNING) ? this.err_stream : this.stream;
      stream.write(
          '[' + getDate() + ']'

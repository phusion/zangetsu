...
ShardRouterClient.prototype._handleCommand_listLocks = function() {
	//...
	this._writeJSON({ status: 'ok', results: results});
}

ShardRouterClient.prototype._handleCommand_giveLock = function() {
}

ShardRouterClient.prototype._handleCommand_receiveLock = function() {
}
